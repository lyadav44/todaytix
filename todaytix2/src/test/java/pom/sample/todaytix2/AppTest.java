...
public class AppTest {
	...
	@Test
	public void verifyLoginWithoutEnteringPassword() throws InterruptedException {
	...
	@Test
	public void verifyLoginEnteringInvalidEmail() {

		driver.findElement(By.id("navBarLoginButton")).click();
		driver.findElement(By.xpath("//span[text()='Email']")).click();
		driver.findElement(By.id("sign-in-email-field")).sendKeys("test");// Please Enter your User name here

		driver.findElement(By.id("sign-in-submit")).click();

		String expectedLoginError = "Invalid email address";
		String actualLoginError = driver.findElement(By.xpath("//p[@id='sign-in-email-field-helper-text']")).getText();
		try {
			Thread.sleep(2000);
